...
module.exports = {
  ...
  SUDO: process.env.SUDO || '916260273863',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME,
  HEROKU_API_KEY: process.env.HEROKU_API_KEY,
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️MR-SHUBHAM',
  ...
  ANTIWORDS: process.env.ANTIWORDS || 'xxx',
  MENTION: process.env.MENTION || '',
  MAX_UPLOAD: process.env.MAX_UPLOAD || 500,
